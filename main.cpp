...
int main(int argc, char** argv) {
    ...
    char cmd[10];
    strcpy(cmd, "pdftotext \"C:\\Users\\gener\\Documents\\books\\Le-Forex-pour-les-débutants-ambitieux-Jelle-Peters.pdf\"");
    */
    ...
    detector.setConfidenceThreshold(confThreshold).setConfidenceThreshold(nmsThreshold);
    ...
    bool openSuccess = parser.has("input") ? cap.open(parser.get<String>("input"), 2000) : cap.open(0);
